...
namespace {
   const char * openGlErrorString(gles2::error_code_t err) {
      // TODO: this should be generated by glgen
      switch (err) {
      case gles2::error_code_t::invalid_enum: return "GL_INVALID_ENUM";
      case gles2::error_code_t::invalid_value: return "GL_INVALID_VALUE";
      case gles2::error_code_t::invalid_operation: return "GL_INVALID_OPERATION";
...
void checkOpenGLError(const char* function, const char* file, int line) {
   auto err = gles2::get_error(); if (err == gles2::error_code_t::no_error) return;
...
namespace {
   ...
   std::string get_shader_info_log(glpp::id_t shader_id)
   {
      ...
      gles2::get_shaderiv(shader_id, gles2::get_shaderiv_p_name_t::info_log_length, &length);

      if (length) {
         char* buffer = new char[length];
         gles2::get_shader_info_log(shader_id, length, NULL, buffer);
   ...
   void delete_program_shaders(glpp::id_t id) {
      ...
      gles2::get_programiv(id, gles2::get_programiv_p_name_t::attached_shaders, &shader_count);

      std::vector<GLuint> shaders(shader_count);
      gles2::get_attached_shaders(id, shader_count, nullptr, shaders.data());

      for (auto s : shaders) { gles2::delete_shader(s); }
   }

   gles2::shader_type_t to_glenum(glpp::shader::Type type) {
      switch (type) {
      case glpp::shader::Vertex: return gles2::shader_type_t::vertex_shader;
      case glpp::shader::Fragment: return gles2::shader_type_t::fragment_shader;
      default: throw glpp::error("unsupported shader type");
      }
   }

   glpp::ValueType gl_to_value_type(gles2::attrib_type_t type) {
      switch (type) {
      case gles2::attrib_type_t::float_: return glpp::ValueType::Float;
      case gles2::attrib_type_t::float_vec2: return glpp::ValueType::FloatVec2;
      case gles2::attrib_type_t::float_vec3: return glpp::ValueType::FloatVec3;
      case gles2::attrib_type_t::float_vec4: return glpp::ValueType::FloatVec4;
      case gles2::attrib_type_t::float_mat2: return glpp::ValueType::FloatMat2;
      case gles2::attrib_type_t::float_mat3: return glpp::ValueType::FloatMat3;
      case gles2::attrib_type_t::float_mat4: return glpp::ValueType::FloatMat4;
      default: return glpp::ValueType::Unknown;
      }
   }

   glpp::ValueType gl_to_value_type(gles2::uniform_type_t type) {
      switch (type) {
      case gles2::uniform_type_t::int_: return glpp::ValueType::Int;
      case gles2::uniform_type_t::float_: return glpp::ValueType::Float;
      case gles2::uniform_type_t::float_vec2: return glpp::ValueType::FloatVec2;
      case gles2::uniform_type_t::float_vec3: return glpp::ValueType::FloatVec3;
      case gles2::uniform_type_t::float_vec4: return glpp::ValueType::FloatVec4;
      case gles2::uniform_type_t::int_vec2: return glpp::ValueType::IntVec2;
      case gles2::uniform_type_t::int_vec3: return glpp::ValueType::IntVec3;
      case gles2::uniform_type_t::int_vec4: return glpp::ValueType::IntVec4;
      case gles2::uniform_type_t::bool_: return glpp::ValueType::Bool;
      case gles2::uniform_type_t::bool_vec2: return glpp::ValueType::BoolVec2;
      case gles2::uniform_type_t::bool_vec3: return glpp::ValueType::BoolVec3;
      case gles2::uniform_type_t::bool_vec4: return glpp::ValueType::BoolVec4;
      case gles2::uniform_type_t::float_mat2: return glpp::ValueType::FloatMat2;
      case gles2::uniform_type_t::float_mat3: return glpp::ValueType::FloatMat3;
      case gles2::uniform_type_t::float_mat4: return glpp::ValueType::FloatMat4;
      case gles2::uniform_type_t::sampler_2d: return glpp::ValueType::Sampler2d;
      case gles2::uniform_type_t::sampler_cube: return glpp::ValueType::SamplerCube;
   ...
   gles2::draw_elements_type_t element_index_gl_type(glpp::ValueType type) {
      switch (type) {
      case glpp::ValueType::UByte: return gles2::draw_elements_type_t::unsigned_byte_;
      case glpp::ValueType::UShort: return gles2::draw_elements_type_t::unsigned_short_;
      case glpp::ValueType::UInt: return gles2::draw_elements_type_t::unsigned_int_;
      default: throw glpp::error("invalid element index type when drawing");
      }
   }

   gles2::vertex_attrib_pointer_type_t attrib_atomic_gl_type(glpp::ValueType type) {
      switch (type) {
      case glpp::ValueType::Byte: return gles2::vertex_attrib_pointer_type_t::byte_;
      case glpp::ValueType::UByte: return gles2::vertex_attrib_pointer_type_t::unsigned_byte_;
      case glpp::ValueType::Short: return gles2::vertex_attrib_pointer_type_t::short_;
      case glpp::ValueType::UShort: return gles2::vertex_attrib_pointer_type_t::unsigned_short_;
      //case glpp::ValueType::Int: return GL_INT;
      //case glpp::ValueType::UInt: return GL_UNSIGNED_INT;
      case glpp::ValueType::Float: return gles2::vertex_attrib_pointer_type_t::float_;
      //case glpp::ValueType::Double: return GL_DOUBLE;

      case glpp::ValueType::FloatVec2: return gles2::vertex_attrib_pointer_type_t::float_;
      case glpp::ValueType::FloatVec3: return gles2::vertex_attrib_pointer_type_t::float_;
      case glpp::ValueType::FloatVec4: return gles2::vertex_attrib_pointer_type_t::float_;
      ...
      case glpp::ValueType::FloatMat2: return gles2::vertex_attrib_pointer_type_t::float_;
      case glpp::ValueType::FloatMat3: return gles2::vertex_attrib_pointer_type_t::float_;
      case glpp::ValueType::FloatMat4: return gles2::vertex_attrib_pointer_type_t::float_;
...
namespace glpp
{
   ...
   */
   ...
   : format_(texture_t::RGBA) { // TODO: this may not be right?
      ...
      GL_VERIFY(gles2::bind_texture(gles2::texture_target_t::texture_2d, id_));
      ...
      GL_VERIFY(gles2::tex_parameteri(gles2::texture_target_t::texture_2d, gles2::texture_parameter_name_t::texture_wrap_s, TMP_GL_CLAMP_TO_EDGE));
      GL_VERIFY(gles2::tex_parameteri(gles2::texture_target_t::texture_2d, gles2::texture_parameter_name_t::texture_wrap_t, TMP_GL_CLAMP_TO_EDGE));
      GL_VERIFY(gles2::tex_parameteri(gles2::texture_target_t::texture_2d, gles2::texture_parameter_name_t::texture_mag_filter, TMP_GL_NEAREST));
      GL_VERIFY(gles2::tex_parameteri(gles2::texture_target_t::texture_2d, gles2::texture_parameter_name_t::texture_min_filter, TMP_GL_NEAREST));
   ...
   void texture_unit_t::activate() const {
      auto texture_unit = static_cast<gles2::texture_unit_t>(static_cast<unsigned int>(gles2::texture_unit_t::texture0) + id);
      GL_VERIFY(gles2::active_texture(texture_unit));
   }
   ...
   */
   ...
   : dims_(tex.dims()), samples_(0) {
      GL_VERIFY(gles2::gen_framebuffers(1, &fbo_id_));
      GL_VERIFY(gles2::bind_framebuffer(gles2::framebuffer_target_t::framebuffer, fbo_id_));
      ...
      GL_VERIFY(gles2::framebuffer_texture_2d(gles2::framebuffer_target_t::framebuffer, gles2::framebuffer_attachment_t::color_attachment0, gles2::framebuffer_texture_target_t::texture_2d, tex.id(), 0));

      // create render buffer for stencil and depth (we arent interested in reading it)
      GL_VERIFY(gles2::gen_renderbuffers(1, &depth_rbo_id_));
      GL_VERIFY(gles2::bind_renderbuffer(gles2::renderbuffer_target_t::renderbuffer, depth_rbo_id_));
      GL_VERIFY(gles2::renderbuffer_storage(gles2::renderbuffer_target_t::renderbuffer, gles2::internal_format_t::depth_component16, dims_.x, dims_.y)); // GL_DEPTH24_STENCIL8
      GL_VERIFY(gles2::framebuffer_renderbuffer(gles2::framebuffer_target_t::framebuffer, gles2::framebuffer_attachment_t::depth_attachment, gles2::renderbuffer_target_t::renderbuffer, depth_rbo_id_)); // GL_DEPTH_STENCIL_ATTACHMENT

      GL_VERIFY(gles2::bind_renderbuffer(gles2::renderbuffer_target_t::renderbuffer, 0));

      check_fbo();

      GL_VERIFY(gles2::bind_framebuffer(gles2::framebuffer_target_t::framebuffer, 0));
   }
   ...
   frame_buffer_t::frame_buffer_t(dim_t dims, unsigned samples)
      ...
      GL_VERIFY(gles2::gen_renderbuffers(1, &colour_rbo_id_));
      GL_VERIFY(gles2::bind_renderbuffer(gles2::renderbuffer_target_t::renderbuffer, colour_rbo_id_));
#ifdef WIN32
   ...
   frame_buffer_t::~frame_buffer_t() {
      if (0 != depth_rbo_id_) GL_VERIFY(gles2::delete_renderbuffers(1, &depth_rbo_id_));
      if (0 != colour_rbo_id_) GL_VERIFY(gles2::delete_renderbuffers(1, &colour_rbo_id_));
      GL_VERIFY(gles2::delete_framebuffers(1, &fbo_id_));
   }

   void frame_buffer_t::bind(BindTarget target) const {
      check_fbo();
      gles2::framebuffer_target_t t
         = target == ReadDraw ? gles2::framebuffer_target_t::framebuffer
         : target == Read ? gles2::framebuffer_target_t::read_framebuffer
         : target == Draw ? gles2::framebuffer_target_t::draw_framebuffer
         : throw error("unrecognised bind target");

      // TODO: this was GL_READ_FRAMEBUFFER_ANGLE for some reason???
      if (target == ReadDraw) gles2::bind_framebuffer(gles2::framebuffer_target_t::read_framebuffer, 0);
      GL_VERIFY(gles2::bind_framebuffer(t, fbo_id_));
   }
   ...
   void frame_buffer_t::unbind(BindTarget target) const {
      gles2::framebuffer_target_t t
         ...
         : target == Draw ? gles2::framebuffer_target_t::draw_framebuffer
         : throw error("unrecognised bind target");
      GL_VERIFY(gles2::bind_framebuffer(t, 0));
   }
   ...
   void frame_buffer_t::blit_to_draw_buffer() const {
      ...
      GL_VERIFY(gles2::bind_framebuffer(gles2::framebuffer_target_t::read_framebuffer, fbo_id_)); // Make sure your multisampled FBO is the read framebuffer
#ifdef WIN32
      gl::int_t TMP_GL_NEAREST = 0x2600;
   ...
   void frame_buffer_t::blit_to_screen() const {
      // TODO: this was GL_READ_FRAMEBUFFER_ANGLE for some reason
      GL_VERIFY(gles2::bind_framebuffer(gles2::framebuffer_target_t::draw_framebuffer, 0));
      blit_to_draw_buffer();
   }
   ...
   void frame_buffer_t::check_fbo() const {
      ...
      auto status = gles2::check_framebuffer_status(gles2::framebuffer_target_t::framebuffer);
      if (status != gles2::framebuffer_status_t::framebuffer_complete) {
         auto status_msg = [status] {
            switch (status) {
               //case GL_FRAMEBUFFER_UNDEFINED: return "GL_FRAMEBUFFER_UNDEFINED";
            case gles2::framebuffer_status_t::framebuffer_incomplete_attachment: return "GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT ";
            case gles2::framebuffer_status_t::framebuffer_incomplete_missing_attachment: return "GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT ";
               //case GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER : return "GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER ";
               //case GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER : return "GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER ";
            case gles2::framebuffer_status_t::framebuffer_unsupported: return "GL_FRAMEBUFFER_UNSUPPORTED ";
   ...
   id_t current_frame_buffer() {
      int fbo;
      GL_VERIFY(gles2::get_integerv(gles2::get_p_name_t::framebuffer_binding, &fbo));
      return fbo;
   }

   void bind_frame_buffer(id_t new_fbo) {
      GL_VERIFY(gles2::bind_framebuffer(gles2::framebuffer_target_t::framebuffer, new_fbo));
   }
   ...
   */
   ...
   shader::shader(std::string const & source, shader::Type type)
      : id_(gles2::create_shader(to_glenum(type)))
      , type_(type)
   {
      GL_CHECK();

      const char * srcdata = source.c_str();
      GL_VERIFY(gles2::shader_source(id_, 1, &srcdata, NULL));
      GL_VERIFY(gles2::compile_shader(id_));

      gl::int_t success;
      GL_VERIFY(gles2::get_shaderiv(id_,gles2::get_shaderiv_p_name_t::compile_status, &success));
      if (success != GL_TRUE) {
   ...
   */
   ...
   buffer_t::state::state(void* vertex_data, std::size_t vertex_data_byte_size)
      ...
      gles2::gen_buffers(1, &vertex_id_);
      gles2::bind_buffer(gles2::buffer_target_arb_t::array_buffer, vertex_id_);
      gles2::buffer_data(gles2::buffer_target_arb_t::array_buffer, vertex_data_byte_size, vertex_data, gles2::buffer_usage_arb_t::static_draw);
   }
   ...
   : state(vertex_data, vertex_byte_size) {
      ...
      gles2::gen_buffers(1, &index_id_);
      gles2::bind_buffer(gles2::buffer_target_arb_t::element_array_buffer, index_id_);
      gles2::buffer_data(gles2::buffer_target_arb_t::element_array_buffer, index_byte_size, index_data, gles2::buffer_usage_arb_t::static_draw);
   }
   ...
   buffer_t::state::~state() {
      if (0 != vertex_id_) gles2::delete_buffers(1, &vertex_id_);
      if (0 != index_id_) gles2::delete_buffers(1, &index_id_);
   }
   ...
   void buffer_t::bind() const {
      if (0 != state_->vertex_id_) {
         gles2::bind_buffer(gles2::buffer_target_arb_t::array_buffer, state_->vertex_id_);
      }
      if (0 != state_->index_id_) {
         gles2::bind_buffer(gles2::buffer_target_arb_t::element_array_buffer, state_->index_id_);
      }
   }
   ...
   namespace {
      gles2::primitive_type_t gl_draw_mode(DrawMode mode) {
         switch (mode) {
         case DrawMode::Points: return gles2::primitive_type_t::points;
         case DrawMode::Lines: return gles2::primitive_type_t::lines;
         case DrawMode::LineLoop: return gles2::primitive_type_t::line_loop;
         case DrawMode::Triangles: return gles2::primitive_type_t::triangles;
         case DrawMode::TriangleStrip: return gles2::primitive_type_t::triangle_strip;
         case DrawMode::TriangleFan: return gles2::primitive_type_t::triangle_fan;
   ...
   void draw(buffer_spec_t const & b, DrawMode mode, unsigned first, unsigned count) {
      ...
      if (b.buffer.has_index_data()) {
         ...
         GL_VERIFY(gles2::draw_elements(gl_mode, idx_count, gl_type, idx_start));
      }
      else {
         GL_VERIFY(gles2::draw_arrays(gl_draw_mode(mode), first, count));
      }
   }
   ...
   */
   ...
   void pass_t::draw_(DrawMode mode, unsigned first, unsigned count) {
      ...
      if (nullptr != index_buffer) {
         ...
         GL_VERIFY(gles2::draw_elements(gl_draw_mode(mode), idx_count, gl_type, idx_start));
      }
      else {
         GL_VERIFY(gles2::draw_arrays(gl_draw_mode(mode), first, count));
      }
   ...
   */
   ...
   void program::state::destroy() {
      ...
      gles2::delete_program(id_);
      id_ = 0;
   }

   program::program()
      : state_(std::make_shared<state>()) {
      state_->id_ = gles2::create_program();
      GL_CHECK();
   }
   ...
   void program::reload(shader s1, shader s2) {
      for (auto & s : state_->shaders_) {
         GL_VERIFY(gles2::detach_shader(state_->id_, s.id()));
      }
   ...
   void program::reload() {
      ...
      GL_VERIFY(gles2::link_program(_.id_));

      use();

      gl::int_t num_uniforms;
      GL_VERIFY(gles2::get_programiv(_.id_, gles2::get_programiv_p_name_t::active_uniforms, &num_uniforms));

      for (auto idx = 0; idx < num_uniforms; idx++) {
         int size;
         gles2::uniform_type_t gl_type;
         char name[513];

         GL_VERIFY(gles2::get_active_uniform(_.id_, idx, 512, nullptr, &size, &gl_type, name));
         auto location = gles2::get_uniform_location(_.id_, name);
         if (location == -1) {
      ...
      gles2::get_programiv(_.id_, gles2::get_programiv_p_name_t::active_attributes, &num_attribs);

      for (auto idx = 0; idx < num_attribs; idx++) {
         int size;
         gles2::attrib_type_t gl_type;
         char name[513];

         GL_VERIFY(gles2::get_active_attrib(_.id_, idx, 512, nullptr, &size, &gl_type, name));
         auto location = gles2::get_attrib_location(_.id_, name);
         if (location == -1) {
   ...
   void program::use() const {
      GL_VERIFY(gles2::use_program(state_->id_));
   }
   ...
   void program::attach(shader s) {
      GL_VERIFY(gles2::attach_shader(state_->id_, s.id()));
   ...
   */
   ...
   void set_uniform(int location, glm::ivec4 const & vec) { GL_VERIFY(gles2::uniform_4i(location, vec.x, vec.y, vec.z, vec.w)); }
   void set_uniform(int location, glm::ivec3 const & vec) { GL_VERIFY(gles2::uniform_3i(location, vec.x, vec.y, vec.z)); }
   void set_uniform(int location, glm::ivec2 const & vec) { GL_VERIFY(gles2::uniform_2i(location, vec.x, vec.y)); }
   void set_uniform(int location, float f) { GL_VERIFY(gles2::uniform_1f(location, f)); }
   void set_uniform(int location, int i) { GL_VERIFY(gles2::uniform_1i(location, i)); }
   void set_uniform(int location, texture_unit_t tex) { GL_VERIFY(gles2::uniform_1i(location, tex.id)); }
