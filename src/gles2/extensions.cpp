...
namespace gles2 {
    ...
    */
    ...
    void copy_texture_levels(gl::uint_t destinationTexture, gl::uint_t sourceTexture, gl::int_t sourceBaseLevel, gl::sizei_t sourceLevelCount) {
    ...
    void resolve_multisample_framebuffer() {
    ...
    void get_integer_64v(gl::enum_t pname, gl::int64_t * params) {
      if ( GLAD_GL_APPLE_sync ) {
    ...
    void discard_framebuffer(gl::enum_t target, gl::sizei_t numAttachments, const  gl::enum_t * attachments) {
    ...
    void framebuffer_texture_2d_multisample(gl::enum_t target, gl::enum_t attachment, gl::enum_t textarget, gl::uint_t texture, gl::int_t level, gl::sizei_t samples) {
    ...
    void draw_buffers_indexed(gl::int_t n, const  gl::enum_t * location, const  gl::int_t * indices) {
    ...
    void get_integeri_v(gl::enum_t target, gl::uint_t index, gl::int_t * data) {
      if ( GLAD_GL_EXT_multiview_draw_buffers ) {
    ...
    void read_buffer_indexed(gl::enum_t src, gl::int_t index) {
      if ( GLAD_GL_EXT_multiview_draw_buffers ) {
    ...
    void debug_message_callback(gl::DEBUGPROCKHR_t callback, const  void * userParam) {
    ...
    void readn_pixels(gl::int_t x, gl::int_t y, gl::sizei_t width, gl::sizei_t height, pixel_format_t format, pixel_type_t type, gl::sizei_t bufSize, void * data) {
      if ( GLAD_GL_KHR_robustness ) {
    ...
    void coverage_mask(gl::boolean_t mask) {
    ...
    void coverage_operation(gl::enum_t operation) {
      if ( GLAD_GL_NV_coverage_sample ) {
    ...
    void uniform_matrix_2x_3fv(gl::int_t location, gl::sizei_t count, gl::boolean_t transpose, const  gl::float_t * value) {
    ...
    void uniform_matrix_2x_4fv(gl::int_t location, gl::sizei_t count, gl::boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_NV_non_square_matrices ) {
    ...
    void uniform_matrix_3x_2fv(gl::int_t location, gl::sizei_t count, gl::boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_NV_non_square_matrices ) {
    ...
    void uniform_matrix_3x_4fv(gl::int_t location, gl::sizei_t count, gl::boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_NV_non_square_matrices ) {
    ...
    void uniform_matrix_4x_2fv(gl::int_t location, gl::sizei_t count, gl::boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_NV_non_square_matrices ) {
    ...
    void uniform_matrix_4x_3fv(gl::int_t location, gl::sizei_t count, gl::boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_NV_non_square_matrices ) {
    ...
    void read_buffer(gl::enum_t mode) {
    ...
    void depth_range_arrayfv(gl::uint_t first, gl::sizei_t count, const  gl::float_t * v) {
    ...
    void depth_range_indexedf(gl::uint_t index, gl::float_t n, gl::float_t f) {
      if ( GLAD_GL_NV_viewport_array ) {
    ...
    void egl_image_target_renderbuffer_storage(gl::enum_t target, gl::eglImageOES_t image) {
    ...
    void egl_image_target_texture_2d(gl::enum_t target, gl::eglImageOES_t image) {
      if ( GLAD_GL_OES_EGL_image ) {
    ...
    void color_maski(gl::uint_t index, gl::boolean_t r, gl::boolean_t g, gl::boolean_t b, gl::boolean_t a) {
      if ( GLAD_GL_OES_draw_buffers_indexed ) {
    ...
    void disablei(gl::enum_t target, gl::uint_t index) {
      if ( GLAD_GL_OES_draw_buffers_indexed ) {
    ...
    void enablei(gl::enum_t target, gl::uint_t index) {
      if ( GLAD_GL_OES_draw_buffers_indexed ) {
    ...
    gl::boolean_t is_enabledi(gl::enum_t target, gl::uint_t index) {
      if ( GLAD_GL_OES_draw_buffers_indexed ) {
    ...
    void multi_draw_elements_base_vertex(gl::enum_t mode, const  gl::sizei_t * count, draw_elements_type_t type, const  void ** indices, gl::sizei_t primcount, const  gl::int_t * basevertex) {
      if ( GLAD_GL_OES_draw_elements_base_vertex ) {
    ...
    void primitive_bounding_box(gl::float_t minX, gl::float_t minY, gl::float_t minZ, gl::float_t minW, gl::float_t maxX, gl::float_t maxY, gl::float_t maxZ, gl::float_t maxW) {
    ...
    void alpha_func(alpha_function_t func, gl::clampf_t ref) {
    ...
    void disable_driver_control(gl::uint_t driverControl) {
    ...
    void enable_driver_control(gl::uint_t driverControl) {
      if ( GLAD_GL_QCOM_driver_control ) {
    ...
    void get_driver_control_string(gl::uint_t driverControl, gl::sizei_t bufSize, gl::sizei_t * length, gl::char_t * driverControlString) {
      if ( GLAD_GL_QCOM_driver_control ) {
    ...
    void get_driver_controls(gl::int_t * num, gl::sizei_t size, gl::uint_t * driverControls) {
      if ( GLAD_GL_QCOM_driver_control ) {
    ...
    void ext_get_buffer_pointerv(gl::enum_t target, void ** params) {
    ...
    void ext_get_buffers(gl::uint_t * buffers, gl::int_t maxBuffers, gl::int_t * numBuffers) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_get_framebuffers(gl::uint_t * framebuffers, gl::int_t maxFramebuffers, gl::int_t * numFramebuffers) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_get_renderbuffers(gl::uint_t * renderbuffers, gl::int_t maxRenderbuffers, gl::int_t * numRenderbuffers) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_get_tex_level_parameteriv(gl::uint_t texture, gl::enum_t face, gl::int_t level, gl::enum_t pname, gl::int_t * params) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_get_tex_sub_image(gl::enum_t target, gl::int_t level, gl::int_t xoffset, gl::int_t yoffset, gl::int_t zoffset, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, gl::enum_t format, gl::enum_t type, void * texels) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_get_textures(gl::uint_t * textures, gl::int_t maxTextures, gl::int_t * numTextures) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_tex_object_state_overridei(gl::enum_t target, gl::enum_t pname, gl::int_t param) {
      if ( GLAD_GL_QCOM_extended_get ) {
    ...
    void ext_get_program_binary_source(gl::uint_t program, gl::enum_t shadertype, gl::char_t * source, gl::int_t * length) {
    ...
    void ext_get_programs(gl::uint_t * programs, gl::int_t maxPrograms, gl::int_t * numPrograms) {
      if ( GLAD_GL_QCOM_extended_get2 ) {
    ...
    void ext_get_shaders(gl::uint_t * shaders, gl::int_t maxShaders, gl::int_t * numShaders) {
      if ( GLAD_GL_QCOM_extended_get2 ) {
    ...
    gl::boolean_t ext_is_program_binary(gl::uint_t program) {
      if ( GLAD_GL_QCOM_extended_get2 ) {
    ...
    void end_tiling(gl::bitfield_t preserveMask) {
    ...
    void start_tiling(gl::uint_t x, gl::uint_t y, gl::uint_t width, gl::uint_t height, gl::bitfield_t preserveMask) {
      if ( GLAD_GL_QCOM_tiled_rendering ) {
