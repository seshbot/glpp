...
namespace gles2 {
    ...
    void begin_query_ext(gl::enum_t target, gl::uint_t id) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        
        glBeginQueryEXT(target, id);
        
      }
      else {
        throw std::runtime_error("OpenGL command 'glBeginQueryEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    void delete_queries_ext(gl::sizei_t n, const  gl::uint_t * ids) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        ...
        throw std::runtime_error("OpenGL command 'glDeleteQueriesEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    void end_query_ext(gl::enum_t target) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        ...
        throw std::runtime_error("OpenGL command 'glEndQueryEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    void gen_queries_ext(gl::sizei_t n, gl::uint_t * ids) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        ...
        throw std::runtime_error("OpenGL command 'glGenQueriesEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    void get_query_objectuiv_ext(gl::uint_t id, gl::enum_t pname, gl::uint_t * params) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        ...
        throw std::runtime_error("OpenGL command 'glGetQueryObjectuivEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    void get_queryiv_ext(gl::enum_t target, gl::enum_t pname, gl::int_t * params) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        ...
        throw std::runtime_error("OpenGL command 'glGetQueryivEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    boolean_t is_query_ext(gl::uint_t id) {
      if ( GLAD_GL_EXT_occlusion_query_boolean || GLAD_GL_EXT_disjoint_timer_query ) {
        ...
        throw std::runtime_error("OpenGL command 'glIsQueryEXT' not available on this platform (extensions: GL_EXT_occlusion_query_boolean, GL_EXT_disjoint_timer_query)");
      }
    }
    ...
    gl::enum_t path_glyph_index_range_nv(gl::enum_t fontTarget, const  void * fontName, gl::bitfield_t fontStyle, gl::uint_t pathParameterTemplate, gl::float_t emScale, gl::uint_t * baseAndCount) {
      if ( false && GLAD_GL_NV_path_rendering ) {
