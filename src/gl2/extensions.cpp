...
namespace gl2 {
    ...
    boolean_t are_programs_resident_nv(gl::sizei_t n, const  gl::uint_t * programs, boolean_t * residences) {
      if ( GLAD_GL_NV_vertex_program ) {
        GLboolean residences_; 
        return static_cast<boolean_t>(glAreProgramsResidentNV(n, programs, &residences_));
        *residences = static_cast<gl::boolean_t>(residences_); 
      }
      else {
    ...
    boolean_t are_textures_resident_ext(gl::sizei_t n, const  gl::uint_t * textures, boolean_t * residences) {
      if ( GLAD_GL_EXT_texture_object ) {
        GLboolean residences_; 
        return static_cast<boolean_t>(glAreTexturesResidentEXT(n, textures, &residences_));
        *residences = static_cast<gl::boolean_t>(residences_); 
      }
      else {
    ...
    void bind_image_texture(gl::uint_t unit, gl::uint_t texture, gl::int_t level, boolean_t layered, gl::int_t layer, gl::enum_t access, gl::enum_t format) {
      if ( GLAD_GL_ARB_shader_image_load_store ) {
        
        glBindImageTexture(unit, texture, level, static_cast<GLboolean>(layered), layer, access, format);
    ...
    void bind_image_texture_ext(gl::uint_t index, gl::uint_t texture, gl::int_t level, boolean_t layered, gl::int_t layer, gl::enum_t access, gl::int_t format) {
      if ( GLAD_GL_EXT_shader_image_load_store ) {
        
        glBindImageTextureEXT(index, texture, level, static_cast<GLboolean>(layered), layer, access, format);
    ...
    void color_mask_indexed_ext(gl::uint_t index, boolean_t r, boolean_t g, boolean_t b, boolean_t a) {
      if ( GLAD_GL_EXT_draw_buffers2 ) {
        
        glColorMaskIndexedEXT(index, static_cast<GLboolean>(r), static_cast<GLboolean>(g), static_cast<GLboolean>(b), static_cast<GLboolean>(a));
    ...
    void combiner_output_nv(gl::enum_t stage, gl::enum_t portion, gl::enum_t abOutput, gl::enum_t cdOutput, gl::enum_t sumOutput, gl::enum_t scale, gl::enum_t bias, boolean_t abDotProduct, boolean_t cdDotProduct, boolean_t muxSum) {
      if ( GLAD_GL_NV_register_combiners ) {
        
        glCombinerOutputNV(stage, portion, abOutput, cdOutput, sumOutput, scale, bias, static_cast<GLboolean>(abDotProduct), static_cast<GLboolean>(cdDotProduct), static_cast<GLboolean>(muxSum));
    ...
    void debug_message_control(gl::enum_t source, gl::enum_t type, gl::enum_t severity, gl::sizei_t count, const  gl::uint_t * ids, boolean_t enabled) {
      if ( GLAD_GL_KHR_debug ) {
        
        glDebugMessageControl(source, type, severity, count, ids, static_cast<GLboolean>(enabled));
    ...
    void debug_message_control_arb(gl::enum_t source, gl::enum_t type, gl::enum_t severity, gl::sizei_t count, const  gl::uint_t * ids, boolean_t enabled) {
      if ( GLAD_GL_ARB_debug_output ) {
        
        glDebugMessageControlARB(source, type, severity, count, ids, static_cast<GLboolean>(enabled));
    ...
    void debug_message_enable_amd(gl::enum_t category, gl::enum_t severity, gl::sizei_t count, const  gl::uint_t * ids, boolean_t enabled) {
      if ( GLAD_GL_AMD_debug_output ) {
        
        glDebugMessageEnableAMD(category, severity, count, ids, static_cast<GLboolean>(enabled));
    ...
    void edge_flag_pointer_ext(gl::sizei_t stride, gl::sizei_t count, const  boolean_t * pointer) {
      if ( GLAD_GL_EXT_vertex_array ) {
        GLboolean pointer_; 
        glEdgeFlagPointerEXT(stride, count, &pointer_);
        *pointer = static_cast<gl::boolean_t>(pointer_); 
      }
      else {
    ...
    void framebuffer_draw_buffers_ext(gl::uint_t framebuffer, gl::sizei_t n, const  draw_buffer_mode_t * bufs) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        GLenum bufs_; 
        glFramebufferDrawBuffersEXT(framebuffer, n, &bufs_);
        *bufs = static_cast<gl::enum_t>(bufs_); 
      }
      else {
    ...
    void get_active_attrib_arb(gl::handleARB_t programObj, gl::uint_t index, gl::sizei_t maxLength, gl::sizei_t * length, gl::int_t * size, attrib_type_t * type, gl::charARB_t * name) {
      if ( GLAD_GL_ARB_vertex_shader ) {
        GLenum type_; 
        glGetActiveAttribARB(programObj, index, maxLength, length, size, &type_, name);
        *type = static_cast<gl::enum_t>(type_); 
      }
      else {
    ...
    void get_active_uniform_arb(gl::handleARB_t programObj, gl::uint_t index, gl::sizei_t maxLength, gl::sizei_t * length, gl::int_t * size, uniform_type_t * type, gl::charARB_t * name) {
      if ( GLAD_GL_ARB_shader_objects ) {
        GLenum type_; 
        glGetActiveUniformARB(programObj, index, maxLength, length, size, &type_, name);
        *type = static_cast<gl::enum_t>(type_); 
      }
      else {
    ...
    void get_boolean_indexedv_ext(gl::enum_t target, gl::uint_t index, boolean_t * data) {
      if ( GLAD_GL_EXT_direct_state_access || GLAD_GL_EXT_draw_buffers2 ) {
        GLboolean data_; 
        glGetBooleanIndexedvEXT(target, index, &data_);
        *data = static_cast<gl::boolean_t>(data_); 
      }
      else {
    ...
    void get_histogram(gl::enum_t target, boolean_t reset, pixel_format_t format, pixel_type_t type, void * values) {
      if ( GLAD_GL_ARB_imaging ) {
        
        glGetHistogram(target, static_cast<GLboolean>(reset), static_cast<GLenum>(format), static_cast<GLenum>(type), values);
    ...
    void get_histogram_ext(histogram_target_ext_t target, boolean_t reset, pixel_format_t format, pixel_type_t type, void * values) {
      if ( GLAD_GL_EXT_histogram ) {
        
        glGetHistogramEXT(static_cast<GLenum>(target), static_cast<GLboolean>(reset), static_cast<GLenum>(format), static_cast<GLenum>(type), values);
    ...
    void get_invariant_booleanv_ext(gl::uint_t id, gl::enum_t value, boolean_t * data) {
      if ( GLAD_GL_EXT_vertex_shader ) {
        GLboolean data_; 
        glGetInvariantBooleanvEXT(id, value, &data_);
        *data = static_cast<gl::boolean_t>(data_); 
      }
      else {
    ...
    void get_local_constant_booleanv_ext(gl::uint_t id, gl::enum_t value, boolean_t * data) {
      if ( GLAD_GL_EXT_vertex_shader ) {
        GLboolean data_; 
        glGetLocalConstantBooleanvEXT(id, value, &data_);
        *data = static_cast<gl::boolean_t>(data_); 
      }
      else {
    ...
    void get_map_control_points_nv(gl::enum_t target, gl::uint_t index, gl::enum_t type, gl::sizei_t ustride, gl::sizei_t vstride, boolean_t packed, void * points) {
      if ( GLAD_GL_NV_evaluators ) {
        
        glGetMapControlPointsNV(target, index, type, ustride, vstride, static_cast<GLboolean>(packed), points);
    ...
    void get_minmax(gl::enum_t target, boolean_t reset, pixel_format_t format, pixel_type_t type, void * values) {
      if ( GLAD_GL_ARB_imaging ) {
        
        glGetMinmax(target, static_cast<GLboolean>(reset), static_cast<GLenum>(format), static_cast<GLenum>(type), values);
    ...
    void get_minmax_ext(minmax_target_ext_t target, boolean_t reset, pixel_format_t format, pixel_type_t type, void * values) {
      if ( GLAD_GL_EXT_histogram ) {
        
        glGetMinmaxEXT(static_cast<GLenum>(target), static_cast<GLboolean>(reset), static_cast<GLenum>(format), static_cast<GLenum>(type), values);
    ...
    void get_uniformi_64v_nv(gl::uint_t program, gl::int_t location, gl::int64EXT_t * params) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        
        glGetUniformi64vNV(program, location, params);
        
      }
      else {
        throw std::runtime_error("OpenGL command 'glGetUniformi64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void get_uniformui_64v_nv(gl::uint_t program, gl::int_t location, gl::uint64EXT_t * params) {
      if ( GLAD_GL_NV_shader_buffer_load || GLAD_GL_AMD_gpu_shader_int64 ) {
        
        glGetUniformui64vNV(program, location, params);
        
      }
      else {
        throw std::runtime_error("OpenGL command 'glGetUniformui64vNV' not available on this platform (extensions: GL_NV_shader_buffer_load, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void get_variant_booleanv_ext(gl::uint_t id, gl::enum_t value, boolean_t * data) {
      if ( GLAD_GL_EXT_vertex_shader ) {
        GLboolean data_; 
        glGetVariantBooleanvEXT(id, value, &data_);
        *data = static_cast<gl::boolean_t>(data_); 
      }
      else {
    ...
    void getn_histogram_arb(gl::enum_t target, boolean_t reset, gl::enum_t format, gl::enum_t type, gl::sizei_t bufSize, void * values) {
      if ( GLAD_GL_ARB_robustness ) {
        
        glGetnHistogramARB(target, static_cast<GLboolean>(reset), format, type, bufSize, values);
    ...
    void getn_minmax_arb(gl::enum_t target, boolean_t reset, gl::enum_t format, gl::enum_t type, gl::sizei_t bufSize, void * values) {
      if ( GLAD_GL_ARB_robustness ) {
        
        glGetnMinmaxARB(target, static_cast<GLboolean>(reset), format, type, bufSize, values);
    ...
    void histogram(gl::enum_t target, gl::sizei_t width, gl::enum_t internalformat, boolean_t sink) {
      if ( GLAD_GL_ARB_imaging ) {
        
        glHistogram(target, width, internalformat, static_cast<GLboolean>(sink));
    ...
    void histogram_ext(histogram_target_ext_t target, gl::sizei_t width, gl::enum_t internalformat, boolean_t sink) {
      if ( GLAD_GL_EXT_histogram ) {
        
        glHistogramEXT(static_cast<GLenum>(target), width, internalformat, static_cast<GLboolean>(sink));
    ...
    boolean_t is_async_marker_sgix(gl::uint_t marker) {
      if ( GLAD_GL_SGIX_async ) {
        
        return static_cast<boolean_t>(glIsAsyncMarkerSGIX(marker));
    ...
    boolean_t is_buffer_arb(gl::uint_t buffer) {
      if ( GLAD_GL_ARB_vertex_buffer_object ) {
        
        return static_cast<boolean_t>(glIsBufferARB(buffer));
    ...
    boolean_t is_buffer_resident_nv(gl::enum_t target) {
      if ( GLAD_GL_NV_shader_buffer_load ) {
        
        return static_cast<boolean_t>(glIsBufferResidentNV(target));
    ...
    boolean_t is_enabled_indexed_ext(gl::enum_t target, gl::uint_t index) {
      if ( GLAD_GL_EXT_direct_state_access || GLAD_GL_EXT_draw_buffers2 ) {
        
        return static_cast<boolean_t>(glIsEnabledIndexedEXT(target, index));
    ...
    boolean_t is_fence_apple(gl::uint_t fence) {
      if ( GLAD_GL_APPLE_fence ) {
        
        return static_cast<boolean_t>(glIsFenceAPPLE(fence));
    ...
    boolean_t is_framebuffer_ext(gl::uint_t framebuffer) {
      if ( GLAD_GL_EXT_framebuffer_object ) {
        
        return static_cast<boolean_t>(glIsFramebufferEXT(framebuffer));
    ...
    boolean_t is_image_handle_resident_arb(gl::uint64_t handle) {
      if ( GLAD_GL_ARB_bindless_texture ) {
        
        return static_cast<boolean_t>(glIsImageHandleResidentARB(handle));
    ...
    boolean_t is_name_amd(gl::enum_t identifier, gl::uint_t name) {
      if ( GLAD_GL_AMD_name_gen_delete ) {
        
        return static_cast<boolean_t>(glIsNameAMD(identifier, name));
    ...
    boolean_t is_named_buffer_resident_nv(gl::uint_t buffer) {
      if ( GLAD_GL_NV_shader_buffer_load ) {
        
        return static_cast<boolean_t>(glIsNamedBufferResidentNV(buffer));
    ...
    boolean_t is_named_string_arb(gl::int_t namelen, const  gl::char_t * name) {
      if ( GLAD_GL_ARB_shading_language_include ) {
        
        return static_cast<boolean_t>(glIsNamedStringARB(namelen, name));
    ...
    boolean_t is_object_buffer_ati(gl::uint_t buffer) {
      if ( GLAD_GL_ATI_vertex_array_object ) {
        
        return static_cast<boolean_t>(glIsObjectBufferATI(buffer));
    ...
    boolean_t is_occlusion_query_nv(gl::uint_t id) {
      if ( GLAD_GL_NV_occlusion_query ) {
        
        return static_cast<boolean_t>(glIsOcclusionQueryNV(id));
    ...
    boolean_t is_program_arb(gl::uint_t program) {
      if ( GLAD_GL_ARB_vertex_program || GLAD_GL_ARB_fragment_program ) {
        
        return static_cast<boolean_t>(glIsProgramARB(program));
    ...
    boolean_t is_program_nv(gl::uint_t id) {
      if ( GLAD_GL_NV_vertex_program ) {
        
        return static_cast<boolean_t>(glIsProgramNV(id));
    ...
    boolean_t is_program_pipeline(gl::uint_t pipeline) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        return static_cast<boolean_t>(glIsProgramPipeline(pipeline));
    ...
    boolean_t is_query_arb(gl::uint_t id) {
      if ( GLAD_GL_ARB_occlusion_query ) {
        
        return static_cast<boolean_t>(glIsQueryARB(id));
    ...
    boolean_t is_renderbuffer_ext(gl::uint_t renderbuffer) {
      if ( GLAD_GL_EXT_framebuffer_object ) {
        
        return static_cast<boolean_t>(glIsRenderbufferEXT(renderbuffer));
    ...
    boolean_t is_sampler(gl::uint_t sampler) {
      if ( GLAD_GL_ARB_sampler_objects ) {
        
        return static_cast<boolean_t>(glIsSampler(sampler));
    ...
    boolean_t is_sync(gl::sync_t sync) {
      if ( GLAD_GL_ARB_sync ) {
        
        return static_cast<boolean_t>(glIsSync(sync));
    ...
    boolean_t is_texture_ext(gl::uint_t texture) {
      if ( GLAD_GL_EXT_texture_object ) {
        
        return static_cast<boolean_t>(glIsTextureEXT(texture));
    ...
    boolean_t is_texture_handle_resident_arb(gl::uint64_t handle) {
      if ( GLAD_GL_ARB_bindless_texture ) {
        
        return static_cast<boolean_t>(glIsTextureHandleResidentARB(handle));
    ...
    boolean_t is_transform_feedback(gl::uint_t id) {
      if ( GLAD_GL_ARB_transform_feedback2 ) {
        
        return static_cast<boolean_t>(glIsTransformFeedback(id));
    ...
    boolean_t is_transform_feedback_nv(gl::uint_t id) {
      if ( GLAD_GL_NV_transform_feedback2 ) {
        
        return static_cast<boolean_t>(glIsTransformFeedbackNV(id));
    ...
    boolean_t is_variant_enabled_ext(gl::uint_t id, gl::enum_t cap) {
      if ( GLAD_GL_EXT_vertex_shader ) {
        
        return static_cast<boolean_t>(glIsVariantEnabledEXT(id, cap));
    ...
    boolean_t is_vertex_array(gl::uint_t array) {
      if ( GLAD_GL_ARB_vertex_array_object ) {
        
        return static_cast<boolean_t>(glIsVertexArray(array));
    ...
    boolean_t is_vertex_array_apple(gl::uint_t array) {
      if ( GLAD_GL_APPLE_vertex_array_object ) {
        
        return static_cast<boolean_t>(glIsVertexArrayAPPLE(array));
    ...
    boolean_t is_vertex_attrib_enabled_apple(gl::uint_t index, gl::enum_t pname) {
      if ( GLAD_GL_APPLE_vertex_program_evaluators ) {
        
        return static_cast<boolean_t>(glIsVertexAttribEnabledAPPLE(index, pname));
    ...
    void map_control_points_nv(gl::enum_t target, gl::uint_t index, gl::enum_t type, gl::sizei_t ustride, gl::sizei_t vstride, gl::int_t uorder, gl::int_t vorder, boolean_t packed, const  void * points) {
      if ( GLAD_GL_NV_evaluators ) {
        
        glMapControlPointsNV(target, index, type, ustride, vstride, uorder, vorder, static_cast<GLboolean>(packed), points);
    ...
    void minmax(gl::enum_t target, gl::enum_t internalformat, boolean_t sink) {
      if ( GLAD_GL_ARB_imaging ) {
        
        glMinmax(target, internalformat, static_cast<GLboolean>(sink));
    ...
    void minmax_ext(minmax_target_ext_t target, gl::enum_t internalformat, boolean_t sink) {
      if ( GLAD_GL_EXT_histogram ) {
        
        glMinmaxEXT(static_cast<GLenum>(target), internalformat, static_cast<GLboolean>(sink));
    ...
    void multi_mode_draw_arrays_ibm(const  primitive_type_t * mode, const  gl::int_t * first, const  gl::sizei_t * count, gl::sizei_t primcount, gl::int_t modestride) {
      if ( GLAD_GL_IBM_multimode_draw_arrays ) {
        GLenum mode_; 
        glMultiModeDrawArraysIBM(&mode_, first, count, primcount, modestride);
        *mode = static_cast<gl::enum_t>(mode_); 
      }
      else {
    ...
    void multi_mode_draw_elements_ibm(const  primitive_type_t * mode, const  gl::sizei_t * count, draw_elements_type_t type, const  void ** indices, gl::sizei_t primcount, gl::int_t modestride) {
      if ( GLAD_GL_IBM_multimode_draw_arrays ) {
        GLenum mode_; 
        glMultiModeDrawElementsIBM(&mode_, count, static_cast<GLenum>(type), indices, primcount, modestride);
        *mode = static_cast<gl::enum_t>(mode_); 
      }
      else {
    ...
    void program_uniform_1i_64nv(gl::uint_t program, gl::int_t location, gl::int64EXT_t x) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform1i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_1i_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform1i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_1ui_64nv(gl::uint_t program, gl::int_t location, gl::uint64EXT_t x) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform1ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_1ui_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform1ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_2i_64nv(gl::uint_t program, gl::int_t location, gl::int64EXT_t x, gl::int64EXT_t y) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform2i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_2i_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform2i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_2ui_64nv(gl::uint_t program, gl::int_t location, gl::uint64EXT_t x, gl::uint64EXT_t y) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform2ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_2ui_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform2ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_3i_64nv(gl::uint_t program, gl::int_t location, gl::int64EXT_t x, gl::int64EXT_t y, gl::int64EXT_t z) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform3i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_3i_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform3i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_3ui_64nv(gl::uint_t program, gl::int_t location, gl::uint64EXT_t x, gl::uint64EXT_t y, gl::uint64EXT_t z) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform3ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_3ui_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform3ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_4i_64nv(gl::uint_t program, gl::int_t location, gl::int64EXT_t x, gl::int64EXT_t y, gl::int64EXT_t z, gl::int64EXT_t w) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform4i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_4i_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform4i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_4ui_64nv(gl::uint_t program, gl::int_t location, gl::uint64EXT_t x, gl::uint64EXT_t y, gl::uint64EXT_t z, gl::uint64EXT_t w) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform4ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_4ui_64v_nv(gl::uint_t program, gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glProgramUniform4ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void program_uniform_matrix_2dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix2dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix2dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix2fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2x_3dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix2x3dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2x_3dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix2x3dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2x_3fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix2x3fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2x_4dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix2x4dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2x_4dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix2x4dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_2x_4fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix2x4fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix3dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix3dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix3fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3x_2dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix3x2dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3x_2dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix3x2dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3x_2fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix3x2fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3x_4dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix3x4dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3x_4dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix3x4dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_3x_4fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix3x4fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix4dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix4dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix4fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4x_2dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix4x2dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4x_2dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix4x2dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4x_2fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix4x2fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4x_3dv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix4x3dv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4x_3dv_ext(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glProgramUniformMatrix4x3dvEXT(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void program_uniform_matrix_4x_3fv(gl::uint_t program, gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_separate_shader_objects ) {
        
        glProgramUniformMatrix4x3fv(program, location, count, static_cast<GLboolean>(transpose), value);
    ...
    void raster_samples_ext(gl::uint_t samples, gl::boolean_t fixedsamplelocations) {
      if ( GLAD_GL_EXT_texture_filter_minmax || GLAD_GL_NV_framebuffer_mixed_samples || GLAD_GL_EXT_raster_multisample ) {
        
        glRasterSamplesEXT(samples, fixedsamplelocations);
        
      }
      else {
        throw std::runtime_error("OpenGL command 'glRasterSamplesEXT' not available on this platform (extensions: GL_EXT_texture_filter_minmax, GL_NV_framebuffer_mixed_samples, GL_EXT_raster_multisample)");
      }
    }
    ...
    void sample_coverage_arb(gl::float_t value, boolean_t invert) {
      if ( GLAD_GL_ARB_multisample ) {
        
        glSampleCoverageARB(value, static_cast<GLboolean>(invert));
    ...
    void sample_coverage_oes(gl::fixed_t value, boolean_t invert) {
      if ( GLAD_GL_OES_fixed_point ) {
        
        glSampleCoverageOES(value, static_cast<GLboolean>(invert));
    ...
    void sample_mask_ext(gl::clampf_t value, boolean_t invert) {
      if ( GLAD_GL_EXT_multisample ) {
        
        glSampleMaskEXT(value, static_cast<GLboolean>(invert));
    ...
    void sample_mask_sgis(gl::clampf_t value, boolean_t invert) {
      if ( GLAD_GL_SGIS_multisample ) {
        
        glSampleMaskSGIS(value, static_cast<GLboolean>(invert));
    ...
    boolean_t test_fence_apple(gl::uint_t fence) {
      if ( GLAD_GL_APPLE_fence ) {
        
        return static_cast<boolean_t>(glTestFenceAPPLE(fence));
    ...
    boolean_t test_object_apple(gl::enum_t object, gl::uint_t name) {
      if ( GLAD_GL_APPLE_fence ) {
        
        return static_cast<boolean_t>(glTestObjectAPPLE(object, name));
    ...
    void tex_image_2d_multisample(gl::enum_t target, gl::sizei_t samples, gl::enum_t internalformat, gl::sizei_t width, gl::sizei_t height, boolean_t fixedsamplelocations) {
      if ( GLAD_GL_ARB_texture_multisample ) {
        
        glTexImage2DMultisample(target, samples, internalformat, width, height, static_cast<GLboolean>(fixedsamplelocations));
    ...
    void tex_image_2d_multisample_coverage_nv(gl::enum_t target, gl::sizei_t coverageSamples, gl::sizei_t colorSamples, gl::int_t internalFormat, gl::sizei_t width, gl::sizei_t height, boolean_t fixedSampleLocations) {
      if ( GLAD_GL_NV_texture_multisample ) {
        
        glTexImage2DMultisampleCoverageNV(target, coverageSamples, colorSamples, internalFormat, width, height, static_cast<GLboolean>(fixedSampleLocations));
    ...
    void tex_image_3d_multisample(gl::enum_t target, gl::sizei_t samples, gl::enum_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedsamplelocations) {
      if ( GLAD_GL_ARB_texture_multisample ) {
        
        glTexImage3DMultisample(target, samples, internalformat, width, height, depth, static_cast<GLboolean>(fixedsamplelocations));
    ...
    void tex_image_3d_multisample_coverage_nv(gl::enum_t target, gl::sizei_t coverageSamples, gl::sizei_t colorSamples, gl::int_t internalFormat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedSampleLocations) {
      if ( GLAD_GL_NV_texture_multisample ) {
        
        glTexImage3DMultisampleCoverageNV(target, coverageSamples, colorSamples, internalFormat, width, height, depth, static_cast<GLboolean>(fixedSampleLocations));
    ...
    void tex_storage_2d_multisample(gl::enum_t target, gl::sizei_t samples, gl::enum_t internalformat, gl::sizei_t width, gl::sizei_t height, boolean_t fixedsamplelocations) {
      if ( GLAD_GL_ARB_texture_storage_multisample ) {
        
        glTexStorage2DMultisample(target, samples, internalformat, width, height, static_cast<GLboolean>(fixedsamplelocations));
    ...
    void tex_storage_3d_multisample(gl::enum_t target, gl::sizei_t samples, gl::enum_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedsamplelocations) {
      if ( GLAD_GL_ARB_texture_storage_multisample ) {
        
        glTexStorage3DMultisample(target, samples, internalformat, width, height, depth, static_cast<GLboolean>(fixedsamplelocations));
    ...
    void texture_color_mask_sgis(boolean_t red, boolean_t green, boolean_t blue, boolean_t alpha) {
      if ( GLAD_GL_SGIS_texture_color_mask ) {
        
        glTextureColorMaskSGIS(static_cast<GLboolean>(red), static_cast<GLboolean>(green), static_cast<GLboolean>(blue), static_cast<GLboolean>(alpha));
    ...
    void texture_image_2d_multisample_coverage_nv(gl::uint_t texture, gl::enum_t target, gl::sizei_t coverageSamples, gl::sizei_t colorSamples, gl::int_t internalFormat, gl::sizei_t width, gl::sizei_t height, boolean_t fixedSampleLocations) {
      if ( GLAD_GL_NV_texture_multisample ) {
        
        glTextureImage2DMultisampleCoverageNV(texture, target, coverageSamples, colorSamples, internalFormat, width, height, static_cast<GLboolean>(fixedSampleLocations));
    ...
    void texture_image_2d_multisample_nv(gl::uint_t texture, gl::enum_t target, gl::sizei_t samples, gl::int_t internalFormat, gl::sizei_t width, gl::sizei_t height, boolean_t fixedSampleLocations) {
      if ( GLAD_GL_NV_texture_multisample ) {
        
        glTextureImage2DMultisampleNV(texture, target, samples, internalFormat, width, height, static_cast<GLboolean>(fixedSampleLocations));
    ...
    void texture_image_3d_multisample_coverage_nv(gl::uint_t texture, gl::enum_t target, gl::sizei_t coverageSamples, gl::sizei_t colorSamples, gl::int_t internalFormat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedSampleLocations) {
      if ( GLAD_GL_NV_texture_multisample ) {
        
        glTextureImage3DMultisampleCoverageNV(texture, target, coverageSamples, colorSamples, internalFormat, width, height, depth, static_cast<GLboolean>(fixedSampleLocations));
    ...
    void texture_image_3d_multisample_nv(gl::uint_t texture, gl::enum_t target, gl::sizei_t samples, gl::int_t internalFormat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedSampleLocations) {
      if ( GLAD_GL_NV_texture_multisample ) {
        
        glTextureImage3DMultisampleNV(texture, target, samples, internalFormat, width, height, depth, static_cast<GLboolean>(fixedSampleLocations));
    ...
    void texture_storage_2d_multisample_ext(gl::uint_t texture, texture_target_t target, gl::sizei_t samples, gl::enum_t internalformat, gl::sizei_t width, gl::sizei_t height, boolean_t fixedsamplelocations) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glTextureStorage2DMultisampleEXT(texture, static_cast<GLenum>(target), samples, internalformat, width, height, static_cast<GLboolean>(fixedsamplelocations));
    ...
    void texture_storage_3d_multisample_ext(gl::uint_t texture, gl::enum_t target, gl::sizei_t samples, gl::enum_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedsamplelocations) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glTextureStorage3DMultisampleEXT(texture, target, samples, internalformat, width, height, depth, static_cast<GLboolean>(fixedsamplelocations));
    ...
    void uniform_1i_64nv(gl::int_t location, gl::int64EXT_t x) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform1i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_1i_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform1i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_1ui_64nv(gl::int_t location, gl::uint64EXT_t x) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform1ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_1ui_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform1ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_2i_64nv(gl::int_t location, gl::int64EXT_t x, gl::int64EXT_t y) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform2i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_2i_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform2i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_2ui_64nv(gl::int_t location, gl::uint64EXT_t x, gl::uint64EXT_t y) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform2ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_2ui_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform2ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_3i_64nv(gl::int_t location, gl::int64EXT_t x, gl::int64EXT_t y, gl::int64EXT_t z) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform3i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_3i_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform3i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_3ui_64nv(gl::int_t location, gl::uint64EXT_t x, gl::uint64EXT_t y, gl::uint64EXT_t z) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform3ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_3ui_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform3ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_4i_64nv(gl::int_t location, gl::int64EXT_t x, gl::int64EXT_t y, gl::int64EXT_t z, gl::int64EXT_t w) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform4i64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_4i_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::int64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform4i64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_4ui_64nv(gl::int_t location, gl::uint64EXT_t x, gl::uint64EXT_t y, gl::uint64EXT_t z, gl::uint64EXT_t w) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform4ui64NV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_4ui_64v_nv(gl::int_t location, gl::sizei_t count, const  gl::uint64EXT_t * value) {
      if ( GLAD_GL_NV_gpu_shader5 || GLAD_GL_AMD_gpu_shader_int64 ) {
        ...
        throw std::runtime_error("OpenGL command 'glUniform4ui64vNV' not available on this platform (extensions: GL_NV_gpu_shader5, GL_AMD_gpu_shader_int64)");
      }
    }
    ...
    void uniform_matrix_2dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix2dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_2fv_arb(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_shader_objects ) {
        
        glUniformMatrix2fvARB(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_2x_3dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix2x3dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_2x_4dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix2x4dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_3dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix3dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_3fv_arb(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_shader_objects ) {
        
        glUniformMatrix3fvARB(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_3x_2dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix3x2dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_3x_4dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix3x4dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_4dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix4dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_4fv_arb(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::float_t * value) {
      if ( GLAD_GL_ARB_shader_objects ) {
        
        glUniformMatrix4fvARB(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_4x_2dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix4x2dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    void uniform_matrix_4x_3dv(gl::int_t location, gl::sizei_t count, boolean_t transpose, const  gl::double_t * value) {
      if ( GLAD_GL_ARB_gpu_shader_fp64 ) {
        
        glUniformMatrix4x3dv(location, count, static_cast<GLboolean>(transpose), value);
    ...
    boolean_t unmap_buffer_arb(buffer_target_arb_t target) {
      if ( GLAD_GL_ARB_vertex_buffer_object ) {
        
        return static_cast<boolean_t>(glUnmapBufferARB(static_cast<GLenum>(target)));
    ...
    boolean_t unmap_named_buffer(gl::uint_t buffer) {
      if ( GLAD_GL_ARB_direct_state_access ) {
        
        return static_cast<boolean_t>(glUnmapNamedBuffer(buffer));
    ...
    boolean_t unmap_named_buffer_ext(gl::uint_t buffer) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        return static_cast<boolean_t>(glUnmapNamedBufferEXT(buffer));
    ...
    boolean_t vdpau_is_surface_nv(gl::vdpauSurfaceNV_t surface) {
      if ( GLAD_GL_NV_vdpau_interop ) {
        
        return static_cast<boolean_t>(glVDPAUIsSurfaceNV(surface));
    ...
    void vertex_array_vertex_attrib_format_ext(gl::uint_t vaobj, gl::uint_t attribindex, gl::int_t size, gl::enum_t type, boolean_t normalized, gl::uint_t relativeoffset) {
      if ( GLAD_GL_EXT_direct_state_access ) {
        
        glVertexArrayVertexAttribFormatEXT(vaobj, attribindex, size, type, static_cast<GLboolean>(normalized), relativeoffset);
    ...
    void vertex_attrib_array_object_ati(gl::uint_t index, gl::int_t size, vertex_attrib_pointer_type_t type, boolean_t normalized, gl::sizei_t stride, gl::uint_t buffer, gl::uint_t offset) {
      if ( GLAD_GL_ATI_vertex_attrib_array_object ) {
        
        glVertexAttribArrayObjectATI(index, size, static_cast<GLenum>(type), static_cast<GLboolean>(normalized), stride, buffer, offset);
    ...
    void vertex_attrib_format(gl::uint_t attribindex, gl::int_t size, gl::enum_t type, boolean_t normalized, gl::uint_t relativeoffset) {
      if ( GLAD_GL_ARB_vertex_attrib_binding ) {
        
        glVertexAttribFormat(attribindex, size, type, static_cast<GLboolean>(normalized), relativeoffset);
    ...
    void vertex_attrib_format_nv(gl::uint_t index, gl::int_t size, gl::enum_t type, boolean_t normalized, gl::sizei_t stride) {
      if ( GLAD_GL_NV_vertex_buffer_unified_memory ) {
        
        glVertexAttribFormatNV(index, size, type, static_cast<GLboolean>(normalized), stride);
    ...
    void vertex_attrib_p1ui(gl::uint_t index, gl::enum_t type, boolean_t normalized, gl::uint_t value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP1ui(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p1uiv(gl::uint_t index, gl::enum_t type, boolean_t normalized, const  gl::uint_t * value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP1uiv(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p2ui(gl::uint_t index, gl::enum_t type, boolean_t normalized, gl::uint_t value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP2ui(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p2uiv(gl::uint_t index, gl::enum_t type, boolean_t normalized, const  gl::uint_t * value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP2uiv(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p3ui(gl::uint_t index, gl::enum_t type, boolean_t normalized, gl::uint_t value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP3ui(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p3uiv(gl::uint_t index, gl::enum_t type, boolean_t normalized, const  gl::uint_t * value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP3uiv(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p4ui(gl::uint_t index, gl::enum_t type, boolean_t normalized, gl::uint_t value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP4ui(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_p4uiv(gl::uint_t index, gl::enum_t type, boolean_t normalized, const  gl::uint_t * value) {
      if ( GLAD_GL_ARB_vertex_type_2_10_10_10_rev ) {
        
        glVertexAttribP4uiv(index, type, static_cast<GLboolean>(normalized), value);
    ...
    void vertex_attrib_pointer_arb(gl::uint_t index, gl::int_t size, vertex_attrib_pointer_type_t type, boolean_t normalized, gl::sizei_t stride, const  void * pointer) {
      if ( GLAD_GL_ARB_vertex_program || GLAD_GL_ARB_vertex_shader ) {
        
        glVertexAttribPointerARB(index, size, static_cast<GLenum>(type), static_cast<GLboolean>(normalized), stride, pointer);
