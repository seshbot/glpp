...
namespace gl2 {
    ...
    boolean_t are_textures_resident(gl::sizei_t n, const  gl::uint_t * textures, boolean_t * residences) {
      GLboolean residences_; 
      return static_cast<boolean_t>(glAreTexturesResident(n, textures, &residences_));
      *residences = static_cast<boolean_t>(residences_); 
    }
    ...
    void edge_flag(boolean_t flag) {
      
      glEdgeFlag(static_cast<GLboolean>(flag));
    ...
    void edge_flagv(const  boolean_t * flag) {
      GLboolean flag_; 
      glEdgeFlagv(&flag_);
      *flag = static_cast<boolean_t>(flag_); 
    }
    ...
    boolean_t is_list(gl::uint_t list) {
      
      return static_cast<boolean_t>(glIsList(list));
    ...
    boolean_t is_query(gl::uint_t id) {
      
      return static_cast<boolean_t>(glIsQuery(id));
    ...
    boolean_t unmap_buffer(buffer_target_arb_t target) {
      
      return static_cast<boolean_t>(glUnmapBuffer(static_cast<GLenum>(target)));
