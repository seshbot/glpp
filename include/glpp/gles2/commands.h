...
namespace gles2 {
    ...
    void framebuffer_texture_2d(framebuffer_target_t target, framebuffer_attachment_t attachment, gl::enum_t textarget, gl::uint_t texture, gl::int_t level);
    ...
    void get_active_attrib(gl::uint_t program, gl::uint_t index, gl::sizei_t bufSize, gl::sizei_t * length, gl::int_t * size, gl::enum_t * type, gl::char_t * name);

    void get_active_uniform(gl::uint_t program, gl::uint_t index, gl::sizei_t bufSize, gl::sizei_t * length, gl::int_t * size, gl::enum_t * type, gl::char_t * name);
    ...
    void get_framebuffer_attachment_parameteriv(framebuffer_target_t target, framebuffer_attachment_t attachment, get_pointerv_p_name_t pname, gl::int_t * params);
    ...
    void get_programiv(gl::uint_t program, get_pointerv_p_name_t pname, gl::int_t * params);

    void get_renderbuffer_parameteriv(renderbuffer_target_t target, get_pointerv_p_name_t pname, gl::int_t * params);
    ...
    void get_shaderiv(gl::uint_t shader, get_pointerv_p_name_t pname, gl::int_t * params);
    ...
    void shader_source(gl::uint_t shader, gl::sizei_t count, const gl::char_t *const* string, const gl::int_t * length);
