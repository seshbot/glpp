/**
 * This file was autogenerated by glgen (https://github.com/seshbot/glgen) on 2015-02-25
...
namespace gles2 {
   ...
   /**
    * Required by extensions:
    *  - GL_EXT_multi_draw_arrays (gl,gles2,gles1)
    */
    ...
    */
    void blend_equation_separatei_ext(gl::uint_t buf, blend_equation_mode_ext_t modeRGB, blend_equation_mode_ext_t modeAlpha);

   /**
    * Required by extensions:
    *  - GL_EXT_draw_buffers_indexed (gles2)
    */
    void blend_equationi_ext(gl::uint_t buf, blend_equation_mode_t mode);
    ...
    *  - GL_EXT_draw_buffers_indexed (gles2)
    */
    void disablei_ext(framebuffer_target_t target, gl::uint_t index);

   /**
    * Required by extensions:
    *  - GL_EXT_draw_buffers_indexed (gles2)
    */
    void enablei_ext(framebuffer_target_t target, gl::uint_t index);

   /**
    * Required by extensions:
    *  - GL_EXT_draw_buffers_indexed (gles2)
    */
    boolean_t is_enabledi_ext(framebuffer_target_t target, gl::uint_t index);
    ...
    *  - GL_NV_blend_equation_advanced (gl,gles2)
    */
    void blend_parameteri_nv(get_pointerv_p_name_t pname, gl::int_t value);

   /**
    * Required by extensions:
    *  - GL_NV_fence (gl,gles2,gles1)
    */
    ...
    */
    void flush_mapped_buffer_range_ext(framebuffer_target_t target, gl::intptr_t offset, gl::sizeiptr_t length);

   /**
    * Required by extensions:
    *  - GL_EXT_map_buffer_range (gles2,gles1)
    */
    void * map_buffer_range_ext(framebuffer_target_t target, gl::intptr_t offset, gl::sizeiptr_t length, gl::bitfield_t access);
    ...
    *  - GL_OES_mapbuffer (gles2,gles1)
    */
    void * map_buffer_oes(framebuffer_target_t target, gl::enum_t access);
    ...
    *  - GL_EXT_draw_elements_base_vertex (gles2)
    */
    void multi_draw_elements_base_vertex_ext(blend_equation_mode_t mode, const gl::sizei_t * count, draw_elements_type_t type, const void *const* indices, gl::sizei_t primcount, const gl::int_t * basevertex);
    ...
    *  - GL_EXT_base_instance (gles2)
    */
    void draw_elements_instanced_base_instance_ext(primitive_type_t mode, gl::sizei_t count, draw_elements_type_t type, const void * indices, gl::sizei_t instancecount, gl::uint_t baseinstance);

   /**
    * Required by extensions:
    *  - GL_EXT_base_instance (gles2)
    */
    void draw_elements_instanced_base_vertex_base_instance_ext(primitive_type_t mode, gl::sizei_t count, draw_elements_type_t type, const void * indices, gl::sizei_t instancecount, gl::int_t basevertex, gl::uint_t baseinstance);
    ...
    */
    void patch_parameteri_oes(get_pointerv_p_name_t pname, gl::int_t value);

   /**
    * Required by extensions:
    *  - GL_OES_texture_view (gles2)
    */
    void texture_view_oes(gl::uint_t texture, framebuffer_target_t target, gl::uint_t origtexture, internal_format_t internalformat, gl::uint_t minlevel, gl::uint_t numlevels, gl::uint_t minlayer, gl::uint_t numlayers);

   /**
    * Required by extensions:
    *  - GL_EXT_multisampled_render_to_texture (gles2,gles1)
    */
    void framebuffer_texture_2d_multisample_ext(framebuffer_target_t target, framebuffer_attachment_t attachment, gl::enum_t textarget, gl::uint_t texture, gl::int_t level, gl::sizei_t samples);

   /**
    * Required by extensions:
    *  - GL_EXT_multisampled_render_to_texture (gles2,gles1)
    */
    void renderbuffer_storage_multisample_ext(framebuffer_target_t target, gl::sizei_t samples, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);

   /**
    * Required by extensions:
    *  - GL_IMG_multisampled_render_to_texture (gles2,gles1)
    */
    void framebuffer_texture_2d_multisample_img(framebuffer_target_t target, framebuffer_attachment_t attachment, gl::enum_t textarget, gl::uint_t texture, gl::int_t level, gl::sizei_t samples);

   /**
    * Required by extensions:
    *  - GL_IMG_multisampled_render_to_texture (gles2,gles1)
    */
    void renderbuffer_storage_multisample_img(framebuffer_target_t target, gl::sizei_t samples, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);
    ...
    *  - GL_AMD_performance_monitor (gl,gles2)
    */
    void get_perf_monitor_counter_data_amd(gl::uint_t monitor, get_pointerv_p_name_t pname, gl::sizei_t dataSize, gl::uint_t * data, gl::int_t * bytesWritten);

   /**
    * Required by extensions:
    *  - GL_AMD_performance_monitor (gl,gles2)
    */
    void get_perf_monitor_counter_info_amd(gl::uint_t group, gl::uint_t counter, get_pointerv_p_name_t pname, void * data);
    ...
    */
    void tex_buffer_oes(texture_target_t target, internal_format_t internalformat, gl::uint_t buffer);

   /**
    * Required by extensions:
    *  - GL_OES_texture_buffer (gles2)
    */
    void tex_buffer_range_oes(framebuffer_target_t target, internal_format_t internalformat, gl::uint_t buffer, gl::intptr_t offset, gl::sizeiptr_t size);
    ...
    *  - GL_NV_viewport_array (gles2)
    */
    void disablei_nv(framebuffer_target_t target, gl::uint_t index);

   /**
    * Required by extensions:
    *  - GL_NV_viewport_array (gles2)
    */
    void enablei_nv(framebuffer_target_t target, gl::uint_t index);
    ...
    *  - GL_NV_viewport_array (gles2)
    */
    boolean_t is_enabledi_nv(framebuffer_target_t target, gl::uint_t index);
    ...
    *  - GL_OES_draw_elements_base_vertex (gles2)
    */
    void multi_draw_elements_base_vertex_oes(blend_equation_mode_t mode, const gl::sizei_t * count, draw_elements_type_t type, const void *const* indices, gl::sizei_t primcount, const gl::int_t * basevertex);
    ...
    *  - GL_EXT_separate_shader_objects (gl,gles2)
    */
    gl::uint_t create_shader_programv_ext(draw_elements_type_t type, gl::sizei_t count, const gl::char_t ** strings);
    ...
    *  - GL_EXT_separate_shader_objects (gl,gles2)
    */
    void get_program_pipelineiv_ext(gl::uint_t pipeline, get_pointerv_p_name_t pname, gl::int_t * params);
    ...
    */
    void begin_query_ext(framebuffer_target_t target, gl::uint_t id);
    ...
    *  - GL_EXT_disjoint_timer_query (gles2)
    */
    void get_query_objectuiv_ext(gl::uint_t id, get_pointerv_p_name_t pname, gl::uint_t * params);
    ...
    *  - GL_EXT_disjoint_timer_query (gles2)
    */
    void get_queryiv_ext(framebuffer_target_t target, get_pointerv_p_name_t pname, gl::int_t * params);
    ...
    */
    void renderbuffer_storage_multisample_apple(framebuffer_target_t target, gl::sizei_t samples, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);
    ...
    */
    void renderbuffer_storage_multisample_nv(framebuffer_target_t target, gl::sizei_t samples, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);
    ...
    *  - GL_EXT_multiview_draw_buffers (gles2)
    */
    void get_integeri_v_ext(framebuffer_target_t target, gl::uint_t index, gl::int_t * data);
    ...
    */
    void multi_draw_arrays_indirect_ext(blend_equation_mode_t mode, const void * indirect, gl::sizei_t drawcount, gl::sizei_t stride);

   /**
    * Required by extensions:
    *  - GL_EXT_multi_draw_indirect (gles2)
    */
    void multi_draw_elements_indirect_ext(blend_equation_mode_t mode, draw_elements_type_t type, const void * indirect, gl::sizei_t drawcount, gl::sizei_t stride);

   /**
    * Required by extensions:
    *  - GL_OES_EGL_image (gles2,gles1)
    */
    void egl_image_target_renderbuffer_storage_oes(framebuffer_target_t target, gl::eglImageOES_t image);

   /**
    * Required by extensions:
    *  - GL_OES_EGL_image (gles2,gles1)
    */
    void egl_image_target_texture_2does(framebuffer_target_t target, gl::eglImageOES_t image);
    ...
    *  - GL_QCOM_extended_get (gles2,gles1)
    */
    void ext_get_tex_level_parameteriv_qcom(gl::uint_t texture, gl::enum_t face, gl::int_t level, get_pointerv_p_name_t pname, gl::int_t * params);

   /**
    * Required by extensions:
    *  - GL_QCOM_extended_get (gles2,gles1)
    */
    void ext_get_tex_sub_image_qcom(framebuffer_target_t target, gl::int_t level, gl::int_t xoffset, gl::int_t yoffset, gl::int_t zoffset, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, pixel_format_t format, draw_elements_type_t type, void * texels);
    ...
    *  - GL_QCOM_extended_get (gles2,gles1)
    */
    void ext_tex_object_state_overridei_qcom(framebuffer_target_t target, get_pointerv_p_name_t pname, gl::int_t param);
    ...
    */
    void renderbuffer_storage_multisample_angle(framebuffer_target_t target, gl::sizei_t samples, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);

   /**
    * Required by extensions:
    *  - GL_OES_texture_storage_multisample_2d_array (gles2)
    */
    void tex_storage_3d_multisample_oes(framebuffer_target_t target, gl::sizei_t samples, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, boolean_t fixedsamplelocations);
    ...
    */
    void blend_equation_separatei_oes(gl::uint_t buf, blend_equation_mode_ext_t modeRGB, blend_equation_mode_ext_t modeAlpha);

   /**
    * Required by extensions:
    *  - GL_OES_draw_buffers_indexed (gles2)
    */
    void blend_equationi_oes(gl::uint_t buf, blend_equation_mode_t mode);
    ...
    *  - GL_OES_draw_buffers_indexed (gles2)
    */
    void disablei_oes(framebuffer_target_t target, gl::uint_t index);

   /**
    * Required by extensions:
    *  - GL_OES_draw_buffers_indexed (gles2)
    */
    void enablei_oes(framebuffer_target_t target, gl::uint_t index);

   /**
    * Required by extensions:
    *  - GL_OES_draw_buffers_indexed (gles2)
    */
    boolean_t is_enabledi_oes(framebuffer_target_t target, gl::uint_t index);
    ...
    */
    void get_sampler_parameter_iiv_ext(gl::uint_t sampler, get_pointerv_p_name_t pname, gl::int_t * params);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_border_clamp (gles2)
    */
    void get_sampler_parameter_iuiv_ext(gl::uint_t sampler, get_pointerv_p_name_t pname, gl::uint_t * params);
    ...
    *  - GL_EXT_texture_border_clamp (gles2)
    */
    void sampler_parameter_iiv_ext(gl::uint_t sampler, get_pointerv_p_name_t pname, const gl::int_t * param);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_border_clamp (gles2)
    */
    void sampler_parameter_iuiv_ext(gl::uint_t sampler, get_pointerv_p_name_t pname, const gl::uint_t * param);
    ...
    */
    void compressed_tex_image_3does(framebuffer_target_t target, gl::int_t level, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, gl::int_t border, gl::sizei_t imageSize, const void * data);

   /**
    * Required by extensions:
    *  - GL_OES_texture_3D (gles2)
    */
    void compressed_tex_sub_image_3does(framebuffer_target_t target, gl::int_t level, gl::int_t xoffset, gl::int_t yoffset, gl::int_t zoffset, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, pixel_format_t format, gl::sizei_t imageSize, const void * data);

   /**
    * Required by extensions:
    *  - GL_OES_texture_3D (gles2)
    */
    void copy_tex_sub_image_3does(framebuffer_target_t target, gl::int_t level, gl::int_t xoffset, gl::int_t yoffset, gl::int_t zoffset, gl::int_t x, gl::int_t y, gl::sizei_t width, gl::sizei_t height);
    ...
    *  - GL_OES_texture_3D (gles2)
    */
    void tex_image_3does(framebuffer_target_t target, gl::int_t level, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, gl::int_t border, pixel_format_t format, draw_elements_type_t type, const void * pixels);

   /**
    * Required by extensions:
    *  - GL_OES_texture_3D (gles2)
    */
    void tex_sub_image_3does(framebuffer_target_t target, gl::int_t level, gl::int_t xoffset, gl::int_t yoffset, gl::int_t zoffset, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth, pixel_format_t format, draw_elements_type_t type, const void * pixels);
    ...
    *  - GL_EXT_robustness (gles2,gles1)
    */
    void readn_pixels_ext(gl::int_t x, gl::int_t y, gl::sizei_t width, gl::sizei_t height, pixel_format_t format, draw_elements_type_t type, gl::sizei_t bufSize, void * data);
    ...
    *  - GL_KHR_debug (gl,gles2,glcore)
    */
    void debug_message_control_khr(gl::enum_t source, draw_elements_type_t type, gl::enum_t severity, gl::sizei_t count, const gl::uint_t * ids, boolean_t enabled);

   /**
    * Required by extensions:
    *  - GL_KHR_debug (gl,gles2,glcore)
    */
    void debug_message_insert_khr(gl::enum_t source, draw_elements_type_t type, gl::uint_t id, gl::enum_t severity, gl::sizei_t length, const gl::char_t * buf);
    ...
    */
    void patch_parameteri_ext(get_pointerv_p_name_t pname, gl::int_t value);
    ...
    */
    gl::uint64_t get_image_handle_nv(gl::uint_t texture, gl::int_t level, boolean_t layered, gl::int_t layer, pixel_format_t format);
    ...
    */
    void get_sampler_parameter_iiv_oes(gl::uint_t sampler, get_pointerv_p_name_t pname, gl::int_t * params);

   /**
    * Required by extensions:
    *  - GL_OES_texture_border_clamp (gles2)
    */
    void get_sampler_parameter_iuiv_oes(gl::uint_t sampler, get_pointerv_p_name_t pname, gl::uint_t * params);
    ...
    *  - GL_OES_texture_border_clamp (gles2)
    */
    void sampler_parameter_iiv_oes(gl::uint_t sampler, get_pointerv_p_name_t pname, const gl::int_t * param);

   /**
    * Required by extensions:
    *  - GL_OES_texture_border_clamp (gles2)
    */
    void sampler_parameter_iuiv_oes(gl::uint_t sampler, get_pointerv_p_name_t pname, const gl::uint_t * param);
    ...
    *  - GL_EXT_disjoint_timer_query (gles2)
    */
    void get_query_objecti_64v_ext(gl::uint_t id, get_pointerv_p_name_t pname, gl::int64_t * params);

   /**
    * Required by extensions:
    *  - GL_EXT_disjoint_timer_query (gles2)
    */
    void get_query_objectiv_ext(gl::uint_t id, get_pointerv_p_name_t pname, gl::int_t * params);

   /**
    * Required by extensions:
    *  - GL_EXT_disjoint_timer_query (gles2)
    */
    void get_query_objectui_64v_ext(gl::uint_t id, get_pointerv_p_name_t pname, gl::uint64_t * params);

   /**
    * Required by extensions:
    *  - GL_EXT_disjoint_timer_query (gles2)
    */
    void query_counter_ext(gl::uint_t id, framebuffer_target_t target);
    ...
    */
    void get_object_label_ext(draw_elements_type_t type, gl::uint_t object, gl::sizei_t bufSize, gl::sizei_t * length, gl::char_t * label);

   /**
    * Required by extensions:
    *  - GL_EXT_debug_label (gl,gles2)
    */
    void label_object_ext(draw_elements_type_t type, gl::uint_t object, gl::sizei_t length, const gl::char_t * label);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_view (gles2)
    */
    void texture_view_ext(gl::uint_t texture, framebuffer_target_t target, gl::uint_t origtexture, internal_format_t internalformat, gl::uint_t minlevel, gl::uint_t numlevels, gl::uint_t minlayer, gl::uint_t numlayers);
    ...
    */
    void discard_framebuffer_ext(framebuffer_target_t target, gl::sizei_t numAttachments, const gl::enum_t * attachments);

   /**
    * Required by extensions:
    *  - GL_NV_internalformat_sample_query (gl,gles2)
    */
    void get_internalformat_sampleiv_nv(framebuffer_target_t target, internal_format_t internalformat, gl::sizei_t samples, get_pointerv_p_name_t pname, gl::sizei_t bufSize, gl::int_t * params);
    ...
    *  - GL_APPLE_sync (gles2,gles1)
    */
    void get_integer_64v_apple(get_pointerv_p_name_t pname, gl::int64_t * params);

   /**
    * Required by extensions:
    *  - GL_APPLE_sync (gles2,gles1)
    */
    void get_synciv_apple(gl::sync_t sync, get_pointerv_p_name_t pname, gl::sizei_t bufSize, gl::sizei_t * length, gl::int_t * values);
    ...
    */
    void tex_storage_1dext(framebuffer_target_t target, gl::sizei_t levels, internal_format_t internalformat, gl::sizei_t width);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_storage (gles2,gles1)
    */
    void tex_storage_2dext(framebuffer_target_t target, gl::sizei_t levels, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_storage (gles2,gles1)
    */
    void tex_storage_3dext(framebuffer_target_t target, gl::sizei_t levels, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_storage (gles2,gles1)
    */
    void texture_storage_1dext(gl::uint_t texture, framebuffer_target_t target, gl::sizei_t levels, internal_format_t internalformat, gl::sizei_t width);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_storage (gles2,gles1)
    */
    void texture_storage_2dext(gl::uint_t texture, framebuffer_target_t target, gl::sizei_t levels, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_storage (gles2,gles1)
    */
    void texture_storage_3dext(gl::uint_t texture, framebuffer_target_t target, gl::sizei_t levels, internal_format_t internalformat, gl::sizei_t width, gl::sizei_t height, gl::sizei_t depth);

   /**
    * Required by extensions:
    *  - GL_KHR_robustness (gl,gles2,glcore)
    */
    ...
    */
    void tex_buffer_ext(texture_target_t target, internal_format_t internalformat, gl::uint_t buffer);

   /**
    * Required by extensions:
    *  - GL_EXT_texture_buffer (gles2)
    */
    void tex_buffer_range_ext(framebuffer_target_t target, internal_format_t internalformat, gl::uint_t buffer, gl::intptr_t offset, gl::sizeiptr_t size);
